...
LATEST_RUNS_TIME_RANGE_HOURS_DEFAULT = 12.0
try:
    LATEST_RUNS_TIME_RANGE_HOURS = float(
        environ.get("LATEST_RUNS_TIME_RANGE_HOURS", LATEST_RUNS_TIME_RANGE_HOURS_DEFAULT)
    )
except ValueError:
    LATEST_RUNS_TIME_RANGE_HOURS = LATEST_RUNS_TIME_RANGE_HOURS_DEFAULT
del LATEST_RUNS_TIME_RANGE_HOURS_DEFAULT
