...
urlpatterns = [
    ...
    re_path(r"^summary/datatables/$", views.run_summary_datatables, name="run_summary_datatables"),
    ...
    re_path(
        r"^summary/update/datatables/$", views.run_summary_update_datatables, name="run_summary_update_datatables"
    ),
