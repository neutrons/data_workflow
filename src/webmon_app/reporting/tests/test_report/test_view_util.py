...
class ViewUtilTest(TestCase):
    ...
    def test_get_run_status_text_dict(self):
        ...
        self.assertEqual(
            rst[runs_id[1]],
            f"<span id='run_id_{runs_id[1]}' class='green'>complete</span>",
        )
        self.assertEqual(
            rst[runs_id[2]],
            f"<span id='run_id_{runs_id[2]}' class='red'><b>error</b></span>",
        )
        self.assertEqual(
            rst[runs_id[3]],
            f"<span id='run_id_{runs_id[3]}' class='green'>complete</span>",
        )
        self.assertEqual(
            rst[runs_id[4]],
            f"<span id='run_id_{runs_id[4]}' class='red'>incomplete</span>",
        )
