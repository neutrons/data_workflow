...
from reduction.models import ReductionProperty, PropertyModification, PropertyDefault, Choice
...
class TestModels(TestCase):
    ...
    def setUpTestData(cls):
        ...
        rp = ReductionProperty.objects.create(instrument=instrument,
                                              key='key',
                                              value='value')

        PropertyModification.objects.create(property=rp,
                                            value='modified',
                                            user=user)
        ...
        Choice.objects.create(instrument=instrument,
                              property=rp,
