...
class TestView(TestCase):
    ...
    def test_arcs(self):
        ...
        # POST
        response = self.client.post(reverse('reduction:configuration', args=['arcs']),
                                    data={'button_choice': 'submit',
                                          'e_min': -0.2,
                                          'e_step': 0.015,
                                          'e_max': 0.95,
                                          'grouping': 'grp1',
    ...
    def test_seq(self):
        ...
        # POST
        response = self.client.post(reverse('reduction:configuration', args=['seq']),
                                    data={'button_choice': 'submit',
                                          'e_min': -0.2,
                                          'e_step': 0.015,
                                          'e_max': 0.95,
    ...
    def test_corelli(self):
        ...
        # POST
        response = self.client.post(reverse('reduction:configuration', args=['corelli']),
                                    data={'button_choice': 'submit',
                                          'form-INITIAL_FORMS': '0',
                                          'form-TOTAL_FORMS': '0'})
        self.assertEqual(response.status_code, 200)
    ...
    def test_cncs(self):
        ...
        # POST
        response = self.client.post(reverse('reduction:configuration', args=['cncs']),
                                    data={'button_choice': 'submit',
                                          'form-INITIAL_FORMS': '0',
                                          'form-TOTAL_FORMS': '0',
    ...
    def test_ref_m(self):
        ...
        # POST
        response = self.client.post(reverse('reduction:configuration', args=['ref_m']),
                                    data={'button_choice': 'submit',
                                          'bck_width': 10,
                                          'peak_min': 160,
                                          'peak_max': 170,
